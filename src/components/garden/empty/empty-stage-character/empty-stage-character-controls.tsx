...
export function EmptyStageCharacterControls({
  ...
  return (
    <>
      ...
      {allowObjectPlacement ? (
        <div className="pointer-events-none absolute bottom-3 left-1/2 z-50 w-[min(86vw,19rem)] -translate-x-1/2">
          <div
            className={`relative overflow-hidden rounded-xl border px-3 py-2 shadow-[0_10px_24px_rgba(0,0,0,0.24)] ${
              darkMode
              ...
              <div className="relative grid place-items-center">
                {walletGainPopup ? (
                  <p
                    ...
                    className={`pointer-events-none absolute -top-4 inset-x-0 mx-auto w-max rounded-full border px-2 py-0.5 text-[10px] font-semibold animate-[kazenagare-wallet-coin-pop_1.05s_ease-out_forwards] ${
                      darkMode
